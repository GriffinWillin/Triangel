...
while(status=="going"):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT: # exit
            ...
            if(thisGame.score > 1000 and thisGame.score < 4000): # wait until score is within 1000-4000
                ## Tier 2
            ...
            elif(thisGame.score > 4000):    # wait until score exceeds 4000
            ...
            should = randint(0,200)         # 1/200 for spawning a healthpack
            if(should == 30):
                spawn(HPack)
